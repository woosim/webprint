...
function WSEncoder(){
    ...
    this.addFontSize = function(d){
        if(void 0 == d) throw Error("fontSize is undefined.");
        return "<fontSize>" + checkRange(d, 0, 2) + "</fontSize>";
    };

    this.addCodeTable = function(d){
        if(void 0 == d) throw Error("code table is undefined.");
        return "<codeTable>" + checkRegexp(d, /^(cp437|cp850|cp860|cp852|cp857|cp737|cp866|cp775|cp858|win1252|cp874|win1251|win1250|win1253|win1254|win1255|win1258|win1257|euc_kr|shift_jis)$/) + "</codeTable>";
    };
    ...
    this.addText = function(t){
        ...
        if(t != void 0){
            ...
            t.width != void 0? xmlElement+= (" width=" + '"' + checkRange(t.width, 0, 7) + '"'):void 0,
            t.height != void 0? xmlElement+= (" height=" + '"' + checkRange(t.height, 0, 7) + '"'):void 0,
            ...
            t.data != void 0 ? (xmlElement += ">", xmlElement+= encodeEscape(t.data), xmlElement+= "</text>") : xmlElement += "/>";
            return xmlElement;
        }
    ...
    this.addCanvas = function(c){
        ...
        if(void 0 != c && void 0 != c.ctx){ 
            xmlElement = "<image"; 
            var w = c.width, h = c.height, x = c.x, y = c.y;
...
//            console.log(len +":" + binary.length);
    ...
    this.addBarcode = function (b) {
        var xmlElement;
        if (void 0 != b) { 
            xmlElement = "<barcode" + " type=" + '"' + checkRegexp(b.type, /^(upce|upca|ean8|ean13|code39|itf|code128|code93|codabar)$/) + '"';
            xmlElement += " width= " + '"' + checkRange(b.width, 1, 9) + '"';
